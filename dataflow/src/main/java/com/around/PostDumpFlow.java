...
public class PostDumpFlow {
  private static final String PROJECT_ID = "social-network-206503";
  private static final String INSTANCE_ID = "social-network-bigtable";
  ...
  public static void main(String[] args) {
    ...
    CloudBigtableScanConfiguration config = new CloudBigtableScanConfiguration.Builder()
            .withProjectId(PROJECT_ID).withInstanceId(INSTANCE_ID).withTableId("post").build();
    ...
    PCollection<TableRow> bqRows = btRows.apply(ParDo.of(new DoFn<Result, TableRow>() {
      ...
      public void processElement(ProcessContext c) {
        ...
        String message = new String(
                result.getValue(Bytes.toBytes("post"), Bytes.toBytes("message")), UTF8_CHARSET);
    ...
    bqRows.apply(BigQueryIO.Write.named("Write")
